...
namespace PresentacionesAjedrez
{
    public partial class FrmPrincipal : Form
    {
        ...
        private void btnPais_Click_2(object sender, EventArgs e)
        {
            FrmPais p = new FrmPais();
            p.MdiParent = this;
            p.Dock = DockStyle.Fill;
        ...
        private void btnRepresenta_Click(object sender, EventArgs e)
        {
            FrmRepresenta c = new FrmRepresenta();
            c.MdiParent = this;
            c.Dock = DockStyle.Fill;
        ...
        private void btnParticipante_Click_1(object sender, EventArgs e)
        {
            FrmParticipante p = new FrmParticipante();
            p.MdiParent = this;
            p.Dock = DockStyle.Fill;
        ...
        private void btnJugador_Click_1(object sender, EventArgs e)
        {
            FrmJugador j = new FrmJugador();
            j.MdiParent = this;
            j.Dock = DockStyle.Fill;
        ...
        private void btnArbitro_Click_1(object sender, EventArgs e)
        {
            FrmArbitro a = new FrmArbitro();
            a.MdiParent = this;
            a.Dock = DockStyle.Fill;
        ...
        private void btnAloja_Click(object sender, EventArgs e)
        {
            FrmAlojamiento r = new FrmAlojamiento();
            r.MdiParent = this;
            r.Dock = DockStyle.Fill;
        ...
        private void btnMovimiento_Click_1(object sender, EventArgs e)
        {
            FrmMovimiento m = new FrmMovimiento();
            m.MdiParent = this;
            m.Dock = DockStyle.Fill;
